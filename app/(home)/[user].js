...
const user = () => {
    ...
    const submitAttendance = async () => {
      try {
        ...
        const response = await axios.post("http://10.0.2.2:8000/attendance",attendanceData);
  ...
  return (
    <View style={{ flex: 1, backgroundColor: "white" }}>
      <View
        ...
        <Pressable
        style={{marginVertical: 10, marginHorizontal: 12, flexDirection: "row", gap: 10,}}>
        <View
                style={{
                  width: 50,
                  height: 50,
              ...
              <View>
                ...
                <Text style={{marginTop:5,color:"gray"}}>{params?.designation} ({params?.id})
                </Text>
              </View>
        </Pressable>
